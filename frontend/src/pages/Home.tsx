      ...
      >
          <div className={"mt-12 md:mt-20"}>
              <div className="my-4 text-center leading-8 md:leading-10">
                  ...
                  <p className="text-4xl md:text-7xl tracking-wide font-bold md:my-4">NAIROBI</p>
                  <p className="italic text-2xl md:text-4xl font-semibold text-gray-900 text-shadow-lg animate-pulse shadow-primary">OCT 18-19</p>
              </div>
              ...
              <p className={"max-w-[800px] px-4 md:text-xl my-6 m-auto text-gray-700 mb-5"}>
              ...
              <button
                  className={"px-6 py-4 mt-4 md:mt-16 rounded-full bg-primary cursor-pointer text-white font-bold md:text-lg"}
              >
                  Tickets Coming soon
              </button>

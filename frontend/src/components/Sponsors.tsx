...
export default function Sponsors() {
  return (
    <section
      id="sponsors"
      className={
        "py-8 mt-4 md:mt-8 md:flex md:flex-row items-center justify-between max-w-[1440px] mx-auto"
      }
    >
      <div className={"md:w-1/2 text-center md:text-left"}>
        ...
        <p className={"text-gray-600 px-2 mb-12 md:mb-16 text-justify py-2"}>
          Don't miss this chance to supercharge your brand and tap into the

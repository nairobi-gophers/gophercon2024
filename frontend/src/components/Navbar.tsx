  ...
  return (
    <>
            ...
            <Dialog.Portal>
              ...
              <Dialog.Content className="fixed top-[50%] left-[50%] w-[100vw] translate-x-[-50%] translate-y-[-50%] bg-white h-[100vh] px-6 pt-3">
                ...
                <div className="flex flex-col text-secondary items-center text-center">
                  ...
                  <Dialog.Close className="border-b-2 border-white w-fit p-3">
                    <Link to="/sponsors" className="border-b-2 border-white p-3">Sponsors</Link>
                  </Dialog.Close>
      ...
      <nav className="hidden lg:flex absolute top-0 p-3 w-fit mx-auto text-center left-0 right-0 text-secondary flex-row gap-3 text-sm items-center bg-white">
        ...
        <Link to="/" className="border-b-2 border-white p-3">
          Home
        </Link>
        <Link to="/speakers" className="border-b-2 border-white p-3">
          Speakers
        </Link>
        <Link to="/tickets" className="border-b-2 border-white p-3">
          Tickets
        </Link>
        <Link to="/sponsors" className="border-b-2 border-white p-3">
          Sponsors
        </Link>
        <button className="border-b-2 border-white p-3" onClick={() => scroll('contact')}>
          Contact
        </button>
      </nav>
    </>
